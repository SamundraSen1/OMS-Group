...
<li><a href="<?php web_root?>index.php?q=return">Return Policy</a></li>
<li><a href="<?php web_root?>index.php?q=track">Track Your Item</a></li>
<li><a href="<?php web_root?>index.php?q=about">About Us</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-3">
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2><span>Lightosphere</span></h2>
              <p> 100% Australian owned and operated business based at Sydney, New South Wales, Australia</p>
            </div>
          </div>
...
<script type="text/javascript" language="javascript" src="<?php echo web_root; ?>js/oms.js"></script> 
 <script type="text/javascript">
